...
const DepartementsHome = () => {
  ...
  <div className=" grid items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
    ...
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:gap-3">
      <div className="flex flex-col items-start gap-1 rounded-lg border border-gray-200 bg-gray-50 p-4 w-full max-w-sm justify-center overflow-hidden dark:border-gray-800 dark:bg-gray-950">
        <img
